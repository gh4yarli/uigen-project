...
// Mock ToolCallBadge to keep MessageList tests focused
vi.mock("../ToolCallBadge", () => ({
  ToolCallBadge: ({ toolInvocation }: { toolInvocation: { toolName: string } }) => (
    <div data-testid="tool-call-badge">{toolInvocation.toolName}</div>
  ),
}));
